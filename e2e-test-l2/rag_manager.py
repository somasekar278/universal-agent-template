...
class RAGManager:
    ...
    def _auto_setup(self):
        ...
        print(f"\n🔧 Setting up RAG with {self.backend}...")
        ...
        try:
            ...
            print(f"✅ RAG ready ({self.backend})!\n")
    ...
    def _setup_pgvector(self):
        ...
        try:
            if self.index_type == "hnsw":
                ...
                """)
                print("   ✓ Vector index created (HNSW - optimized for accuracy)")
            else:
                ...
                self.lakebase.execute("""
                    ...
                    WITH (lists = 100)
                """)
                print("   ✓ Vector index created (IVFFlat - optimized for updates)")
        except Exception as e:
    ...
    def _setup_vector_search(self):
        ...
        print(f"   ✓ Vector Search Endpoint: {self.vs_endpoint}")
        print(f"   ✓ Index: {self.vs_index}")
        print(f"   ✓ Delta Table: {self.delta_table}")
        ...
        try:
            ...
            print(f"   ⚠️  Vector Search setup error: {e}")
    ...
    def _create_delta_table_for_docs(self):
        ...
        try:
            ...
            print(f"   ✓ Delta table created/validated: {self.delta_table}")
        except Exception as e:
            print(f"   ⚠️  Delta table creation: {e}")
    ...
    def _create_vector_search_index(self):
        ...
        try:
            ...
            try:
                ...
                print(f"   ✓ Vector Search index exists: {index.name}")
                return
            except:
                pass  # Index doesn't exist, create it
            
            # Create index
            print(f"   🔧 Creating Vector Search index (this may take a few minutes)...")
            ...
            print(f"   ✓ Vector Search index created: {self.vs_index}")
            print(f"   ⏳ Index is syncing... This may take a few minutes for first sync")
    ...
    def _auto_index_documents(self):
        ...
        - Store in backend
        """
        print(f"📄 Checking documents in {self.source}...")
        ...
        try:
            ...
            if not files:
                print("   ⚠️  No files found in UC Volume")
                return
            ...
            if not new_files:
                print(f"   ✅ All {len(files)} documents already indexed")
                return
            
            print(f"   🔄 Indexing {len(new_files)} new/modified documents...")
            ...
            print(f"   ✅ Indexed {indexed_count}/{len(new_files)} documents")
        ...
        if self.backend == "pgvector":
            ...
            for i, chunk in enumerate(chunks):
                ...
                try:
                    ...
                    print(f"   ⚠️  Failed to insert chunk {i} for {file_path}: {e}")
    ...
    def _retrieve_vector_search(self, query: str, top_k: int) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️  Vector Search retrieval failed: {e}")
            return []
    ...
    def _sync_vector_search_index(self):
        ...
        try:
            ...
            print(f"   🔄 Syncing Vector Search index...")
            w.vector_search_indexes.sync_index(self.vs_index)
            print(f"   ✓ Vector Search sync triggered")
            
        except Exception as e:
            print(f"   ⚠️  Vector Search sync failed: {e}")
